...
<?if($arResult["ID"]):?>
	...
	<?if($code == 'tabs'):?>
		...
		<?if($bShowDetailTextTab || $bShowPropsTab || $bShowVideoTab || $templateData["OFFERS_INFO"]["OFFERS_MORE"] /*|| $bShowHowBuyTab || $bShowPaymentTab || $bShowDeliveryTab*/ || $bShowStoresTab || $bShowCustomTab || $bShowReviewsTab):?>
									...
									<?elseif(IsModuleInstalled("blog") && $arParams['REVIEWS_VIEW'] == 'EXTENDED' && ($arParams['USE_REVIEW'] == 'Y' || $arParams["DETAIL_USE_COMMENTS"] == 'Y') ):?>
										<div id="reviews_content">
											...
											<?ob_start()?>
												...
												<?=\Aspro\Functions\CAsproNext::showComments()?>
												<?$html=ob_get_clean();?>
